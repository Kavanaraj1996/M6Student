...
public class SeleniumUtility {
	...
	/**
	 * this method is use to select an option from drop down based on attribute
	 * @param element
	 * @param value
	 */
	...
	/**
	 * this method is use to de select an option from drop down based on value att
	 * @param element
	 * @param value
	 */
	...
	/**
	 * this method is used to de select all options
	 * @param element
	 */
	...
	/**
	 * this method help to accept the alert
	 * @param driver
	 */
	 ...
	 * @param value
	 */
	public void opperationsWithJs(WebDriver driver,String value) {
	...
	/**
	 * this  method is used for custom click
	 * @param driver
	 * @param element
	 * @param time
	 * @throws Exception
	 */
	public void ifElementClickFails(WebDriver driver,WebElement element,int time) 
			throws Exception {
		int count=0;
		int reclickCount=5;
